...
public class SemiCivDrawing
    ...
    public SemiCivDrawing( DrawingEditor editor, Game game ) {
        super();
            ...
            for ( int c = 0; c < GameConstants.WORLDSIZE; c++ ) {
                ...
                if ( city != null ) {
                    ...
                    CityFigure cityFigure =
                            new CityFigure(new CityImpl(owner,p),new Point(GfxConstants.getXFromColumn(p.getColumn()),GfxConstants.getYFromRow(p.getRow())));
